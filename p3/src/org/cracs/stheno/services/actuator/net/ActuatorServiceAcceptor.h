...
#ifndef ActuatorServiceAcceptor_H
#define	ActuatorServiceAcceptor_H
...
class ActuatorServiceAcceptor : public EventHandler, public CloseListener<ACE_SOCK_Stream, ACE_MT_SYNCH> {
public:
    ActuatorServiceAcceptor(ActuatorService* discovery);                
    virtual ~ActuatorServiceAcceptor();       
    ...
    ActuatorServiceChannelManager& getChannelManager(){
...
protected:       
    ...
    ActuatorServiceChannelManager m_scvHandlers;
    EndpointPtr m_endpointPtr;
    ACE_SOCK_Acceptor m_acceptor;
    ActuatorService* m_streamServer;        
};

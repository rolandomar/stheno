...
#ifndef ActionPacket_H
#define	ActionPacket_H

#include <stheno/core/p2p/net/packet/SthenoStreamPacket.h>
#include <euryale/common/uuid/UUID.h>
#include <euryale/net/endpoint/Endpoint.h>

class ActionPacket : public SthenoStreamPacket {
public:    
    static const UShort ACTION_PACKET_OP = 0x3220;
    
    ActionPacket();
    ActionPacket(InputStream& inputStream);
    ActionPacket(ULong requestID,ACE_Time_Value& timestamp,ACE_Message_Block* payload);

...
class ActionReplyPacket : public SthenoStreamPacket {
public:    
    static const UShort ACTION_REPLY_PACKET_OP = 0x7321;
    
    ActionReplyPacket();
    ActionReplyPacket(InputStream& inputStream);
    ActionReplyPacket(ULong packetID,ULong requestID,ACE_Time_Value& timestamp,bool acception);

 ...
 */
/* 
 * File:   ActuatorAcceptor.h
 * Author: rmartins
 *
 * Created on November 22, 2010, 12:28 PM
 */

#ifndef ActuatorAcceptor_H
#define	ActuatorAcceptor_H
...
class ActuatorAcceptor : public EventHandler, public CloseListener<ACE_SOCK_Stream, ACE_MT_SYNCH> {
public:
    ActuatorAcceptor(ActuatorServer* discovery);                
    virtual ~ActuatorAcceptor();       
...
protected:       
    ...
    ACE_Strong_Bound_Ptr<ThreadPerConnection, ACE_Recursive_Thread_Mutex>* m_tpcPtr;
    EndpointPtr m_endpointPtr;
    ACE_SOCK_Acceptor m_acceptor;
    ActuatorServer* m_streamServer;        
};

#endif	/* ActuatorAcceptor_H */

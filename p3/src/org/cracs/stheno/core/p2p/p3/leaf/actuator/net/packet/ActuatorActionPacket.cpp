...
#include "ActuatorActionPacket.h"

ActuatorActionPacket::ActuatorActionPacket():
m_payload(0)
{
}

ActuatorActionPacket::ActuatorActionPacket(InputStream& inputStream):
m_payload(0)
{
...
void
ActuatorActionPacket::serialize(OutputStream& outputStream) throw (SerializationException&) {
...
ACE_Message_Block* ActuatorActionPacket::getPayload() {
    return m_payload;
}

ACE_Time_Value& ActuatorActionPacket::getTimestamp(){
    return m_timestamp;    
}

void
ActuatorActionPacket::serializeBody(OutputStream& outputStream) throw (SerializationException&) {
...
void
ActuatorActionPacket::deserializeBody(InputStream& inputStream) throw (SerializationException&) {
    LongLong secs;
    ULongLong usecs;

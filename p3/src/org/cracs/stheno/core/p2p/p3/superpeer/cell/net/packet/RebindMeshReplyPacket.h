 ...
 */
/* 
 * File:   RebindMeshReplyPacket.h
 * Author: rmartins
 *
 * Created on September 3, 2010, 12:16 PM
 */

#ifndef REBINDMESHREPLYPACKET_H
#define	REBINDMESHREPLYPACKET_H
...
class RebindMeshReplyPacket : public SthenoPacket {
public:
    
    RebindMeshReplyPacket(UUIDPtr& srcPID,
            UUIDPtr& srcFID,
            UUIDPtr& dstPID,
            UUIDPtr& dstFID,
            ULong packetID,
            ULong requestID,
            bool acception) :
    SthenoPacket(srcPID, srcFID, dstPID, dstFID, REBIND_MESH_REPLY_PACKET, packetID),
    ...
    RebindMeshReplyPacket() : m_acception(false),SthenoPacket() {
    }

    virtual ~RebindMeshReplyPacket();

 ...
 */
/* 
 * File:   DiscoveryPacketFactory.cpp
 * Author: rmartins
 * 
...
DiscoveryPacketFactory::DiscoveryPacketFactory() {
}

DiscoveryPacketFactory::~DiscoveryPacketFactory() {
}

SthenoStreamPacket* DiscoveryPacketFactory::createPacket(SthenoStreamHeader* header, ByteInputStream& is) {

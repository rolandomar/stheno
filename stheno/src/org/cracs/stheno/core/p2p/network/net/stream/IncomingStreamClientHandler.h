 ...
 */
/* 
 * File:   IncomingStreamClientHandler.h
 * Author: rmartins
 *
 * Created on November 5, 2010, 3:33 PM
 */

#ifndef INCOMINGSTREAMCLIENTHANDLER_H
#define	INCOMINGSTREAMCLIENTHANDLER_H
...
public:
    IncomingStreamClientHandler();
    virtual ~IncomingStreamClientHandler();
...
#endif	/* INCOMINGSTREAMCLIENTHANDLER_H */
